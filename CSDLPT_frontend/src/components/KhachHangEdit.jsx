...
const KhachHangEdit = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        axios.post('/api/khachhang/new', khachHang)
            .then(response => {
                alert(response.data);
            })
            .catch((error) => {
                ...
                if (confirmBox) {
                    axios.post('/api/khachhang/new/confirm', { result: 'yes' })
                        .then(response => {
                            alert(response.data);
                        });
                } else {
                    axios.post('/api/khachhang/new/confirm', { result: 'no' })
                        .then(response => {
                            alert(response.data);
                        }); 
                }
                    ...
                    <div className="row">
                        <FormGroup className="col-md-5 mb-3">
                            ...
                            <Input type="text" name="maKH" id="maKH" value={khachHang.maKH}
                                onChange={handleChange} autoComplete="maKH" required />
                        </FormGroup>
                        <FormGroup className="col-md-5 mb-3">
                            <Label for="tenKH">Tên KH</Label>
                            <Input type="text" name="tenKH" id="tenKH" value={khachHang.tenKH}
                                onChange={handleChange} autoComplete="tenKH" required />
                        </FormGroup>
                    </div>
                    <div className="row">
                        <FormGroup className="col-md-5 mb-3">
                            ...
                            <Input type="date" name="ngaySinh" id="ngaySinh" value={khachHang.ngaySinh}
                                onChange={handleChange} autoComplete="ngaySinh" required />
                        </FormGroup>
                        <FormGroup className="col-md-5 mb-3">
                            <Label for="diaChi">Địa chỉ</Label>
                            <Input type="text" name="diaChi" id="diaChi" value={khachHang.diaChi}
                                onChange={handleChange} autoComplete="diaChi" required />
                        </FormGroup>
                    </div>
                    <div className="row">
                        <FormGroup className="col-md-5 mb-3">
